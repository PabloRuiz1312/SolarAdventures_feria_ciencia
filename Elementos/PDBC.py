...
class DBJuego:
    ...
    def escribirGanadores(nombres,carPuntos):
        ...
        fichero.write("<fo:block font-size=\"16pt\" font-family=\"sans-serif\" font-weight=\"bold\" line-height=\"15pt\" space-after.optimum=\"3pt\" text-align=\"center\" color=\"#EC9191\">\n")
        fichero.write("RANKIN PUNTUACIONES SOLAR ADVENTURES\n")
        fichero.write("</fo:block>\n")
        fichero.write("<fo:block font-size=\"13pt\" font-family=\"sans-serif\" font-weight=\"bold\" line-height=\"15pt\" space-after.optimum=\"3pt\" text-align=\"center\">\n")
