...
class DBJuego:
    ...
    def escribirGanadores(nombres,carPuntos):
        ...
        fichero.write("</fo:block>\n")
        fichero.write("<fo:block font-size=\"18pt\" font-family=\"sans-serif\" font-weight=\"bold\" line-height=\"15pt\" space-after.optimum=\"17pt\" text-align=\"center\">\n")
        fichero.write("IES JANDULA -- Realizado por Pablo Ruiz Canovas\n")
        fichero.write("</fo:block>\n")
